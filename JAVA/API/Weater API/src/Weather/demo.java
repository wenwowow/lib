...
public class demo {
    ...
    //配置您申请的KEY
    public static final String APPKEY ="a3d2346e883064ec70e209186e62532e";
	...
	public static void getRequest1(){
		...
		Map params = new HashMap();//请求参数
            params.put("cityname","荆州");//要查询的城市，如：温州、上海、北京
        ...
        try {
            ...
            if(object.getInt("error_code")==0){
                ...
                String str=xmlAndjson.json2xml(result);
    ...
    {
    	File f=new File("C:\\Users\\Lenovo\\Desktop\\one.xml");
